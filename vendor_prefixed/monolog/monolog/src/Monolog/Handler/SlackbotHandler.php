 ...
 */
class SlackbotHandler extends \BmWoocommerceVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \BmWoocommerceVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
