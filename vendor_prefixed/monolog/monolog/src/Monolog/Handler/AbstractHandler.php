 ...
 */
abstract class AbstractHandler implements \BmWoocommerceVendor\Monolog\Handler\HandlerInterface, \BmWoocommerceVendor\Monolog\ResettableInterface
{
    protected $level = \BmWoocommerceVendor\Monolog\Logger::DEBUG;
    ...
    {
        $this->level = \BmWoocommerceVendor\Monolog\Logger::toMonologLevel($level);
        return $this;
    }
    /**
