 ...
 */
class RotatingFileHandler extends \BmWoocommerceVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \BmWoocommerceVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \BmWoocommerceVendor\Monolog\Utils::canonicalizePath($filename);
