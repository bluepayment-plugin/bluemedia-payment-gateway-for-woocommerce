 ...
 */
class BrowserConsoleHandler extends \BmWoocommerceVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \BmWoocommerceVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
